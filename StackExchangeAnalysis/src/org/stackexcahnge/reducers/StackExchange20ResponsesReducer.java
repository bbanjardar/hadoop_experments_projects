...
public class StackExchange20ResponsesReducer extends Reducer<Text, SEWritable,Text,Text> {
	...
	public void reduce(Text key, Iterable<SEWritable> values, Context context)
		...
		if(responsesCount>=20) {
			System.out.println("***************StackExchange20ResponsesReducer*************responsesCount****** "+ responsesCount);
